...
extern void raw_input_mouse_move(const void *context, double screenPosX, double screenPosY, void *window, double windowPosX, double windowPosY, double windowWidth, double windowHeight);
